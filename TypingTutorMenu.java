...
public class TypingTutorMenu extends JFrame implements ActionListener {
      ...
      public void actionPerformed(ActionEvent e) {
        ...
        lessonOne.addActionListener(new ActionListener(){
          public void actionPerformed(ActionEvent e) {
            ...
            typingScreen.textToType = "fffffffff fffffffff fffffffff jjjjjjjjj jjjjjjjjj jjjjjjjjj ff jj ff jj f j f j fff jjj f f j j j f";
  ...
  public static void recommendDifficulty() {
  	...
  	JLabel recommendedDifficultyLabel = new JLabel("<html><b>Recommended Difficulty: </b>" + difficulty + "<br>You scored " + (int)TypingScreenGUI.score + " points with a typing speed of " + (int)TypingScreenGUI.wpm + "wpm.");
  	JLabel difficultyDescription = new JLabel("<html>You have been recommended the "  + difficulty + " difficulty! It is recommended that you start here, however if you wish to go to a different stage instead, then you have the option to do so!");
  	...
  	switch (difficulty) {
  		case "Introduction": 	introDifficulty.setBackground(Color.GREEN);
  								break;
  		case "Beginner":		beginnerDifficulty.setBackground(Color.GREEN);
  								break;
  		case "Intermediate":	intermediateDifficulty.setBackground(Color.GREEN);
  								break;
  		case "Advanced":		advancedDifficulty.setBackground(Color.GREEN);
  								break;
  		case "Expert":			expertDifficulty.setBackground(Color.GREEN);
  								break;
